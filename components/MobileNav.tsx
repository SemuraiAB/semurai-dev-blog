      ...
      <Transition appear show={navShow} as={Fragment} unmount={false}>
        <Dialog as="div" onClose={onToggleNav} unmount={false}>
          ...
          <Transition.Child
            ...
            unmount={false}
          >
            <Dialog.Panel className="opacity-98 fixed left-0 top-0 z-70 h-full w-full bg-light-beige duration-300 dark:bg-black dark:opacity-[0.98]">
              <nav
                ref={navRef}
                className="bg-green mt-8 flex h-full basis-0 flex-col items-start overflow-y-auto pl-12 pt-2 text-left "
              >
